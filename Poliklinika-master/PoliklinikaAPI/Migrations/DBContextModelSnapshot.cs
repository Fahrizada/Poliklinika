...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Poliklinika.Model.Konsultacije", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Poliklinika.Model.KonsultacijePoruka", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("KonsultacijeID");

                    b.HasIndex("UserID");

                    b.ToTable("KonsultacijePoruka");
                });
            ...
            modelBuilder.Entity("Poliklinika.Model.KonsultacijePoruka", b =>
                {
                    b.HasOne("Poliklinika.Model.Konsultacije", "Konsultacije")
                        .WithMany()
                        .HasForeignKey("KonsultacijeID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Poliklinika.Model.User", "User")
                        .WithMany()
                        .HasForeignKey("UserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
